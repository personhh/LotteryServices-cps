...
public class OtherTest {
    ...
    public void test_DrawStrategy() {
        ...
        System.out.print("输出元祖");
        drawStrategy.rateTupleToString();
        System.out.println("=========");
        for (int i = 0; i < 20; i++) {
...
class DrawStrategy {
    ...
    public void rateTupleToString(){
        for(int i = 0; i < this.rateTuple.length; i++){
            System.out.println( i + " + " + this.rateTuple[i]);
        }
    }
